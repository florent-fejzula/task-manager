  ...
  const handleStatusChange = async (e) => {
    ...
    if (newStatus === "done") {
      ...
      if (outcome) {
        ...
        // Clear the timer itself — closing a task well before its deadline
        // would otherwise leave a stale timerStart/timerDuration that can
        // trigger a "15 minutes left" notification hours later.
